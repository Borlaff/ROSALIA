...
There are many versions of Conda managers. We recommend using free `Miniforge <https://github.com/conda-forge/miniforge>` with mamba as the package manager. All the commands below work exactly the same if you replace "mamba" with "conda". You can install Miniforge by following the instructions at the `Miniforge GitHub repository <https://github.com/conda-forge/miniforge>`_. As a summary, use the following commands: 
...
.. code-block:: sh
       ...
       mamba create -n rosalia python=3.12 conda-forge::astromatic-swarp conda-forge::gnuastro conda-forge::imagemagick conda-forge::ds9

After the new environment is created, we can activate it.

.. code-block:: sh

       mamba activate rosalia
...
Uninstalling ROSALIA
---------------------
mamba remove -n rosalia --all
